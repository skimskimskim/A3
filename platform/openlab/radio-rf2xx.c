...
#define RF2XX_TX_POWER  PHY_POWER_m17dBm // PHY_POWER_m17dBm //ksh.. PHY_POWER_m17dBm // original: PHY_POWER_3dBm (option: m30 - 5)
#endif
...
static int8_t last_rssi=0; //ksh .. //JSB added
...
//    last_rssi = rf2xx_reg_read(RF2XX_DEVICE, RF2XX_REG__PHY_RSSI);  //outputs uint8_t     //ksh..
...
//    *value = rf2xx_reg_read(RF2XX_DEVICE, RF2XX_REG__PHY_ED_LEVEL);

//    *value = (int8_t)rf2xx_reg_read(RF2XX_DEVICE, RF2XX_REG__PHY_ED_LEVEL);
...
//last_rssi_dbm = -90+rf2xx_reg_read(RF2XX_DEVICE, RF2XX_REG__PHY_ED_LEVEL); 
//last_rssi_dbm = -91+rf2xx_reg_read(RF2XX_DEVICE, RF2XX_REG__PHY_RSSI);  //outputs uint8_t
/*
uint8_t rssi=rf2xx_reg_read(RF2XX_DEVICE, RF2XX_REG__PHY_ED_LEVEL); 
if(rssi==0){
 last_rssi_dbm=-90;
}else{
