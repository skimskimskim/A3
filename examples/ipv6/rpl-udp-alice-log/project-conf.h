...
#define MAX_NODE_NUM 65 //70 //ksh.. maximum number of nodes
...
/*******************************************************/
/******************* Configure DIO FILTER **************/
/*******************************************************/

#define DIO_FILTER 1 // 1: enable, 0: disable
#define THRES_DIO_RSSI -80
// core/net/rpl/rpl-icmp6.c // at dio_input()
...
#define IEEE802154_CONF_PANID 0x77aa //original: 0xabcd

#define TSCH_CONF_JOIN_MY_PANID_ONLY 1 //KSH.. 20190521.. tsch_conf_join_my_panid_only
...
#ifndef PERIOD 
#define PERIOD 10 //upstream/downstream send interval
#define PERIOD_SERVER PERIOD //downstream/downstream send interval

#endif

#define SEQUENTIAL_SEND_INTERVAL ((PERIOD_SERVER) * (CLOCK_SECOND) / (MAX_NODE_NUM))

#define START_AFTER_PERIOD (10 * 60 * (CLOCK_SECOND)) //ksh.. RPL construction.. no udp packet during this time.. 
...
#define FIXED_RPL_TOPOLOGY 0 //ksh.. creates fixed rpl topology //1: fixed RPL, 0: normal RPL 
...
#if FIXED_RPL_TOPOLOGY == 1
#define RPL_CONF_WITH_PROBING 0 //ksh.. original: 1
#else
...
#define RPL_CONF_DIS_INTERVAL 5 //ksh.. original: 60s

#define RPL_CONF_DAO_RETRANSMISSION_TIMEOUT (15 * CLOCK_SECOND) //ksh.. if dao fails, retransmit. original: 5sec
...
#define ORCHESTRA_ONE_CHANNEL_OFFSET 0 // ksh. 1: only one channel offset for unicast slotframe , 0: multiple channel offset for unicast slotframe 

#ifdef ALICE1_ORB2_OSB3 
 #if ALICE1_ORB2_OSB3 == 2 //ORB
  #ifdef ORCHESTRA_CONF_UNICAST_SENDER_BASED
    #undef ORCHESTRA_CONF_UNICAST_SENDER_BASED
    #define ORCHESTRA_CONF_UNICAST_SENDER_BASED 0 //Receiver based
  #endif
 #endif
#endif
...
#else //Orchestra RB
#define RPL_CONF_WITH_DAO_ACK 1 //ksh..  original: 0.
